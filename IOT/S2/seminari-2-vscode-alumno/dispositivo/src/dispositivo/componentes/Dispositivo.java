...
public class Dispositivo implements IDispositivo {
	...
	protected ComandoDispositivo_APIMQTT apiComandoMQTT = null;
	...
	public static Dispositivo build(String deviceId, String ip, String mqttBrokerURL) {
		...
		dispositivo.apiComandoMQTT = ComandoDispositivo_APIMQTT.build(dispositivo, mqttBrokerURL);
